...
#ifndef SPACE_GAME__PLAYER_CONTROLLER__H
#define SPACE_GAME__PLAYER_CONTROLLER__H
...
public:
	PlayerController( Ship *ship, Root *root );
...
#endif  //  SPACE_GAME__PLAYER_CONTROLLER__H
