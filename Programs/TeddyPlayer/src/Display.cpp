...
Projection( "TestEvents Display Projection", camera )
{
    ...
    offset_pixels             = Vector2(  0.0f,  -4.0f );  //!<  offset in pixels
    offset_self_size_relative = Vector2( -0.5f,  -1.0f );  //!<  offset relative to self size
    offset_free_size_relative = Vector2(  0.5f,   1.0f );  //!<  offset relative to remaining free size
	fill_base_pixels          = Vector2(-10.0f, -90.0f );  //!<
