...
#ifndef TEDDY__MODELS__TRIANGLE_STRIP__H
#define TEDDY__MODELS__TRIANGLE_STRIP__H
...
class TriangleStrip : public Element {
public:
	TriangleStrip();
...
#endif  //  TEDDY__MODELS__TRIANGLE_STRIP__H
